 ...
 * Curso: 2025-2026
 * DescripciÃ³n: Panel de control (Dashboard) con estadÃ­sticas y tickets recientes.
 */
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>TicketingEVG â€“ Portal de GestiÃ³n</title>
...
<body>
    <header>
        ...
        <a href="lista-tickets.php" class="boton-nav">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-6 col-md-3">
                    <div class="tarjeta-stats" style="animation-delay:.2s">
                        <div class="icono-stats verde"><i class="fa-solid fa-stopwatch"></i></div>
                        <div class="info-estadistica">Tickets pendientes</div>
            ...
            <div class="tarjeta-tickets">
                <div class="cabecera-tickets">
                    <div>
                        ...
                        <p>Ãšltimas solicitudes y actualizaciones de estado.</p>
                    </div>
                    <a href="lista-tickets.php" class="ver-todo">Ver todo <i
                ...
                <div class="cuerpo-tickets">
                    <div class="fila-ticket">
                        ...
                        <div class="info-ticket"><strong>Ordenador no enciende en Aula 203</strong><small>Asignado a:
                                Trabajador 1</small></div>
                        <span class="etiqueta-estado proceso">En proceso</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket azul"><i class="fa-solid fa-circle-info"></i></div>
                        <div class="info-ticket"><strong>Solicitud de marcadores para pizarra</strong></div>
                        <span class="etiqueta-estado pendiente">Pendiente</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
                        <div class="info-ticket"><strong>Proyector muestra imagen borrosa</strong><small>Asignado a:
                                Trabajador 1</small></div>
                        <span class="etiqueta-estado asignado">Asignado</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
                        <div class="info-ticket"><strong>Fallo conexiÃ³n Wi-Fi Sala Profesores</strong></div>
                        <span class="etiqueta-estado pendiente">Pendiente</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket azul"><i class="fa-solid fa-circle-info"></i></div>
                        <div class="info-ticket"><strong>InstalaciÃ³n de software estadÃ­stico</strong><small>Asignado a:
                                Trabajador 1</small></div>
                        <span class="etiqueta-estado asignado">Asignado</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
                        <div class="info-ticket"><strong>SustituciÃ³n de bombilla fundida</strong></div>
