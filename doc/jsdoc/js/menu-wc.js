                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/ConfirmacionEliminarComponent.html" data-type="entity-link" >ConfirmacionEliminarComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/CrearTicketComponent.html" data-type="entity-link" >CrearTicketComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/FormularioCategoriaComponent.html" data-type="entity-link" >FormularioCategoriaComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/FormularioOperarioComponent.html" data-type="entity-link" >FormularioOperarioComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ModalTicketComponent.html" data-type="entity-link" >ModalTicketComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/OperariosComponent.html" data-type="entity-link" >OperariosComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/PortalTicketsComponent.html" data-type="entity-link" >PortalTicketsComponent</a>
                            </li>
                            <li class="link">
