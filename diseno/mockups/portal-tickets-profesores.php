...
<body>
	<header>
		...
		<a href="lista-tickets.php" class="boton-nav fantasma">
		...
		<div class="container-lg">
			...
			<div class="tarjeta-tickets">
				<div class="cabecera-tickets">
					...
					<a href="lista-tickets.php" class="ver-todo">Ver todo <i class="fa-solid fa-arrow-up-right-from-square fa-xs"></i></a>
				</div>
				<div class="cuerpo-tickets">
					<div class="fila-ticket">
						<div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
						<div class="info-ticket"><strong>Ordenador no enciende en Aula 203</strong><small>Asignado a: Trabajador 1</small></div>
					...
					<div class="fila-ticket">
						<div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
						<div class="info-ticket"><strong>Proyector muestra imagen borrosa</strong><small>Asignado a: Trabajador 1</small></div>
					...
					<div class="fila-ticket">
						<div class="punto-ticket azul"><i class="fa-solid fa-circle-info"></i></div>
						<div class="info-ticket"><strong>InstalaciÃ³n de software estadÃ­stico</strong><small>Asignado a: Trabajador 1</small></div>
						<span class="etiqueta-estado asignado">Asignado</span>
					</div>
					<div class="fila-ticket">
						<div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
