 ...
 * Curso: 2025-2026
 * Descripción: Panel de control vacío cuando no hay registros.
 */
?>
<!DOCTYPE html>
<html lang="es">
<head>
	...
	<title>TicketingEVG – Dashboard Vacío</title>
...
<body>
	<header>
		...
		<a href="listaTicketsVacio.php" class="boton-nav">
		...
		<div class="container-lg">
			...
			<div class="tarjeta-tickets">
				<div class="cabecera-tickets">
					...
					<a href="listaTicketsVacio.php" class="ver-todo">Ver todo <i class="fa-solid fa-arrow-up-right-from-square fa-xs"></i></a>
				</div>
