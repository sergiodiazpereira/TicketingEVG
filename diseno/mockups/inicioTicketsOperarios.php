 ...
 * Curso: 2025-2026
 * Descripción: Panel de control (Dashboard) con estadísticas y tickets recientes.
 */
?>
<!DOCTYPE html>
...
<body>
    <header>
        ...
        <a href="inicioTicketsProfesores.php" class="boton-nav activo">
            <i class="fa-solid fa-table-cells-large"></i>
            <span class="etiqueta-nav">Inicio</span>
        </a>
        <a href="listaTickets.php" class="boton-nav">
            ...
            <div class="tarjeta-tickets">
                <div class="cabecera-tickets">
                    <div>
                        ...
                        <p>Últimas solicitudes y actualizaciones de estado.</p>
                    </div>
                    <a href="listaTickets.php" class="ver-todo">Ver todo <i
                ...
                <div class="cuerpo-tickets">
                    ...
                    <div class="fila-ticket">
                        <div class="punto-ticket rojo"><i class="fa-solid fa-circle-exclamation"></i></div>
                        <div class="info-ticket"><strong>Fallo conexión Wi-Fi Sala Profesores</strong></div>
                        <span class="etiqueta-estado pendiente">Pendiente</span>
                    </div>
                    <div class="fila-ticket">
                        <div class="punto-ticket azul"><i class="fa-solid fa-circle-info"></i></div>
                        <div class="info-ticket"><strong>Instalación de software estadístico</strong><small>Asignado a:
                                Trabajador 1</small></div>
                        <span class="etiqueta-estado asignado">Asignado</span>
                    </div>
                    <div class="fila-ticket">
