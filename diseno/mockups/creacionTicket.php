...
<body>
	<header>
		...
		<a href="listaTickets.php" class="boton-nav"><i class="fa-regular fa-clipboard"></i> <span class="etiqueta-nav">Mis tickets</span></a>
	...
	<main>
		<div class="container-lg" style="max-width: 900px;">
			<div class="d-flex align-items-center gap-3 mb-4 cabecera-pagina">
				<a href="listaTickets.php" class="btn-retroceso"><i class="fa-solid fa-arrow-left"></i></a>
				<div>
					<h1>Nuevo ticket</h1>
			...
			<form class="tarjeta-formulario">
				...
				<div class="modal-pie-premium border-top bg-light" style="padding: 1.5rem 2rem;">
					<div class="ms-auto d-flex align-items-center gap-3">
						<a href="listaTickets.php" class="boton-cancelar">Cancelar</a>
